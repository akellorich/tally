	...
	<div id="header" data-role="page">
		...
		<div id="detail" data-role="content">	
			...
			<div id="ballotpaperserials">
				...
				<label for="serialno">Ballot Paper Serial Number:</label>
				...
				<div id="photoinputs">
					<input type="file" accept="image/*" capture="camera" id="attachphoto2">
				</div>
				
				<label for="savelocal">
					<input type="checkbox" data-inline="true" id="saveondevice" name="saveondevice">Save on device and upload later
				</label>
				<button type="button" id="savespoiltballotpaper" data-role="button" data-inline="true">Save</button>
				<button type="button" id="clearspoiltballot" data-role="button" data-inline="true">Clear</button>
			</div>
		</div>	
	</div>	
...
<script type="text/javascript" src="../js/spoiltballotpapers.js"></script>
